    ...
    <>
      ...
      {!isLoading && (
        <Routes>
          ...
          />
          <Route
            path="/blog/best-psychiatrist-patna-depression-anxiety"
            element={<BestPsychiatristPatnaDepressionAnxiety />}
          />
          <Route
            path="/blog/depression-not-just-low-mood"
            element={<DepressionBlog />}
          />
